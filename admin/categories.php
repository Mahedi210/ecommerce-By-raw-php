                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <h4 class="box-link a"><a href="manage_Categories.php">ADD Categories</a></h4>
                        </div>
                        <div class="card-body--">
                                 ...
                                 <tbody>
                                   ...
                                   while ($row= mysqli_fetch_assoc($res)) {?>
                                     <tr>
                                         ...
                                         echo "<span class='badge badge-edit'><a href='manage_Categories.php?type=edite&id=".$row['id']."'>EDIT</a></span> &nbsp";
