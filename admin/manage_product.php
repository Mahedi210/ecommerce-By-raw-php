                ...
                <div class="card">
                    ...
                    <form method="Post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="qty" placeholder="Enter Product quentity" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_desc" placeholder="Enter your Product short description" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" placeholder="Enter your Product  Description" 
                                      class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_title" placeholder="Enter your Product  Meta Title" 
                                      class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_desc" placeholder="Enter your Product  Meta Description" 
                                      class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_keyword" placeholder="Enter your Product  Meta Keyword" 
                                      class="form-control">
