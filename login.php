                        ...
                        <form id="contact-form"  method="post">
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                 ...
                                 <span class="fild_error" id="name_error">dd</span>
                            </div>
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                 ...
                                 <span class="fild_error" id="email_error">dd</span>
                            </div>
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                 ...
                                 <span class="fild_error" id="mobile_error">dd</span>
                            </div>
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    <input type="password" name="password" id="password" placeholder="Your Password*" style="width:100%">
                                </div>
                                 <span class="fild_error" id="password_error">dd</span>
                            </div>
